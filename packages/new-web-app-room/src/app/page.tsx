      ...
      <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm">
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <button
            ...
            className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-4 px-4 rounded-lg transition-colors"
          >
            7
          </button>
          <button
          ...
          <button
            ...
            className="row-span-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-4 rounded-lg transition-colors"
          >
            =
          </button>
          ...
          <button
            ...
            className="col-span-2 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-4 px-4 rounded-lg transition-colors"
          >
            0
          </button>
          <button
